                ...
                <div class="card-body">
                    <div class="col-xl-12 mb-30">
                        <div class="card card-statistics h-100">
                            ...
                            @endif
                                <a href="{{route('teacher.book.create')}}" class="btn btn-success btn-sm" role="button"
                                   aria-pressed="true">{{trans('book_trans.add')}}
                                </a><br><br>
                                    ...
                                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                        ...
                                        @foreach($books as $book)
                                            <tr>
                                                ...
                                                <td>{{$book->added_at}}</td>
                                                <td>
                                                    <a href="{{route('teacher.book.download',$book->file_name)}}" title="{{trans('book_trans.download')}}" class="btn btn-warning btn-sm" role="button" aria-pressed="true"><i class="fa fa-download"></i></a>
                                            ...
                                            @include('pages.teachers.teacher_dashboard.liberary.delete_book')
                                            @include('pages.teachers.teacher_dashboard.liberary.edit_book')
                                        @endforeach
                                    </table>
                                </div>
                            </div>
