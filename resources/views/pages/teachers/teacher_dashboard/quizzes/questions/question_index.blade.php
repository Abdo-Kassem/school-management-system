                    ...
                    <div class="col-xl-12 mb-30">
                        <div class="card card-statistics h-100">
                            <div class="card-body">
                                ...
                                @endif
                                <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#add_question">
                                    ...
                                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                        ...
                                        @foreach($questions as $question)
                                            <tr>
                                                ...
                                                <td>
                                                <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#edit_question{{ $question->id }}"
                                        ...
                                        @include('pages.teachers.teacher_dashboard.quizzes.questions.destroy')
                                        @include('pages.teachers.teacher_dashboard.quizzes.questions.edit')
                                        @endforeach
                                    </table>
                                    @include('pages.teachers.teacher_dashboard.quizzes.questions.add')
                                </div>
                            </div>
                        </div>
                    </div>
