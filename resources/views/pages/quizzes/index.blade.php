                ...
                <div class="card-body">
                    <div class="col-xl-12 mb-30">
                        <div class="card card-statistics h-100">
                            ...
                            @endif
                                <a href="{{route('quizz.create')}}" class="btn btn-success btn-md" role="button"
                                   aria-pressed="true" style="text-transform:capitalize">
                                   {{trans('quizz_trans.add')}}
                                </a><br><br>
                                            ...
                                            <div class="modal fade " id="edit{{$quizz->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-lg" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="{{route('quizz.update')}}" method="post">
                                                                {{csrf_field()}}
